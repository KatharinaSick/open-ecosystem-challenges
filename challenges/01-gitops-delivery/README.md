...
- Level 3 (+60 min): Add canary guards using Prometheus metrics (error rate & latency) and emit OpenTelemetry spans for each rollout step. Surface results as a PR status check or Slack notification.
