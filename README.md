...
mention where deployment manifests live in and which tools are available for debuggin
Tell people to starti n the console with kubectl or k9s and see what's going on
In the first levels all errors are in the appset.yaml -> fix it and then apply it again with command
...
- make sure there is a clear separation between staging & prod through namesapces
  **✅ Completion Criteria**
